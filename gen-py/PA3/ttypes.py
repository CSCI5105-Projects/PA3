...
class CompleteInfo(object):
    ...
    def __init__(self, contact=None, files=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('CompleteInfo')
...
all_structs.append(CompleteInfo)
CompleteInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'contact', [ContactInfo, None], None, ),  # 1
    (2, TType.LIST, 'files', (TType.STRUCT, [FileInfo, None], False), None, ),  # 2
)
